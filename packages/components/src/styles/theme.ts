...
declare module '@mui/material/styles' {
  ...
  interface Palette {
    aiInfo: Palette['primary'];
  }
  interface PaletteOptions {
    aiInfo?: PaletteOptions['primary'];
  }
}
...
const typography = {
  fontFamily: ['Noto Sans JP', 'Noto Sans TC', 'Inter', 'Noto Sans', 'sans-serif'].join(','),
...
const createThemeInstance = (
  ...
  const theme = createTheme({
    palette: { ...palette(themeMode), ...customPalette },
